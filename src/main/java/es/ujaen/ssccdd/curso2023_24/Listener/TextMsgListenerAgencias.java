...
public class TextMsgListenerAgencias implements MessageListener {
     ...
     * @param Lista_Mensaje_Agencia Lista dónde se almacenaran los mensajes recibidos de los clientes.
     @param Sem_Agencias_Viaje Semaforo para desbloquear a la agencia una vez que recibe un mensaje.
     */
    public TextMsgListenerAgencias( String Consumer_Name, List<Mensaje> Lista_Mensaje_Agencia, Semaphore Sem_Agencias_Viaje ) {
        this.Consumer_Name = Consumer_Name;
        this.Lista = Lista_Mensaje_Agencia;
        this.Sem_Agencia_Viaje = Sem_Agencias_Viaje;
    }
    ...
    public void onMessage(Message message) {
        ...
        if (message instanceof TextMessage textMessage) {
            ...
            if ( Consumer_Name.equalsIgnoreCase("Disponibilidad") ) {
                ...
                System.out.println( TEXTO_MORADO + "AGENCIA PARTICULAR----> Se ha recibido un mensaje: " + Mensaje_Servidor.toString() + ". "  + RESET_COLOR );
                Lista.add(Mensaje_Servidor);
                Sem_Agencia_Viaje.release();
                ...
                Mensaje Mensaje_Servidor = Recibir_Mensaje( textMessage, gsonUtil );
                System.out.println( TEXTO_MORADO + "AGENCIA ----> Se ha recibido un mensaje: " + Mensaje_Servidor.toString() + ". " + RESET_COLOR );
                Lista.add(Mensaje_Servidor);
                Sem_Agencia_Viaje.release();
